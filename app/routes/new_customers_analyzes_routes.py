...
from app.service.new_customers_analyze_service import get_monthly_new_customers_analysis, get_weekly_new_customers_analysis
...
def new_customers_per_month_route(smb_id: int):
    try:
        new_customers_monthly_details: list[dict] = get_monthly_new_customers_analysis(smb_id)
...
def new_customers_per_week_route(smb_id: int):
    try:
        new_customers_weekly_details: list[dict] = get_weekly_new_customers_analysis(smb_id)
